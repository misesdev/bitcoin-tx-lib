...
describe("utils", () => {
    ...
    test("hash sha256 and hash256", () => {
        const hash = (0, index_1.sha256)("800C28FCA386C7A227600B2FE50B7CAE11EC86D3BF1FBE471BE89827E19D72AA1D");
        expect(hash).toBeDefined();
        const hash256 = (0, index_1.sha256)("800C28FCA386C7A227600B2FE50B7CAE11EC86D3BF1FBE471BE89827E19D72AA1D", true);
    ...
    test("hash ripemd160", () => {
        ...
        hash = (0, index_1.ripemd160)((0, index_1.hexToBytes)(sha256), true);
    ...
    test("hash256 sha256(sha256(content))", () => {
        const hash = (0, index_1.hash256)("ffff");
