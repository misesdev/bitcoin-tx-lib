...
describe("HDWallet", () => {
    ...
    describe("getAddress / getPairKey consistency (BIP44 vs BIP84)", () => {
        ...
        test("getPairKey type property reflects wallet purpose", () => {
            const { wallet: bip44 } = hdwallet_1.HDWallet.import(MNEMONIC_A, "", { network: "mainnet", purpose: 44 });
            const { wallet: bip84 } = hdwallet_1.HDWallet.import(MNEMONIC_A, "", { network: "mainnet", purpose: 84 });
