...
class HDWallet {
    constructor(hdkManager, options) {
        ...
        this.network = (_a = options === null || options === void 0 ? void 0 : options.network) !== null && _a !== void 0 ? _a : hdkManager.network;
    }
    /**
    ...
    static import(input, password, options) {
        ...
        if (trimmed.split(/\s+/).length > 1) {
            ...
            const wallet = new HDWallet(hdkmanager_1.HDKManager.fromMnemonic(trimmed, password, hdkParams), options);
