...
describe('HDKManager', () => {
    ...
    test('should create an instance from master seed (hex string)', () => {
        const seed = (0, bip39_1.mnemonicToSeedSync)(TEST_MNEMONIC);
        const hexSeed = (0, utils_1.bytesToHex)(seed);
        const hdk = _1.HDKManager.fromMasterSeed(hexSeed);
        expect(hdk).toBeInstanceOf(_1.HDKManager);
    });
    ...
    test('should throw error if derived key has no private key', () => {
        ...
        hdk['root'].derive = () => ({ privateKey: undefined });
